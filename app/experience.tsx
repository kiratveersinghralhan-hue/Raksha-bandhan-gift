...
import { giftConfig } from '../src/config/giftConfig';
import { finalMessage } from '../src/data/finalMessage';
import { memories } from '../src/data/memories';
import { messages } from '../src/data/messages';
import { useReducedMotion } from '../src/hooks/useReducedMotion';
import { AudioControl } from '../src/systems/AudioManager/AudioControl';
import { useQuality } from '../src/systems/QualityManager/useQuality';
import type { Chapter, TransitionKind } from '../src/types/experience';

const World = lazy(() => import('../src/components/three/World').then((module) => ({ default: module.World })));
